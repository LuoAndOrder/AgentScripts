...
The standard library uses this approach in e.g.String::from_utf8method. When
given a vector that doesn’t contain valid UTF-8, aFromUtf8Erroris returned.
You can get original vector back usingFromUtf8Error::into_bytesmethod.
