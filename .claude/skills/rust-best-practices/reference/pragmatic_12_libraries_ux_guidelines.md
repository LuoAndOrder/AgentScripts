...
**Why:** To reduce cognitive load and improve API ergonomics.
...
**Why:** To prevent patterns that don't compose, and design lock-in.
...
**Why:** To harmonize the behavior of error types, and provide a consistent error handling.
...
**Why:** To make essential functionality easily discoverable.
...
**Why:** To give users flexibility calling in with their own types.
...
**Why:** To untangle business logic from I/O logic, and have N*M composability.
...
**Why:** To give users flexibility and clarity when specifying ranges.
...
**Why:** To future-proof type construction in complex scenarios.
...
**Why:** To prevent misuse and accidental parameter mix ups.
...
**Why:** To avoid composability issues when sharing common services.
...
**Why:** To prevent cognitive load and a bad out of the box UX.
