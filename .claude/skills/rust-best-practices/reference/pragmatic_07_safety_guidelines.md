...
**Why:** To prevent undefined behavior, attack surface, and similar 'happy little accidents'.
...
**Why:** To prevent unexpected runtime behavior, leading to potential bugs and incompatibilities.
