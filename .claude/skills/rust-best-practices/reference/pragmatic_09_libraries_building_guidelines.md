...
**Why:** To prevent compilation breakage in large and complex projects.
...
**Why:** To be easily adoptable by the Rust ecosystem.
...
> ****Warning:** Libraries are Responsible for Their Dependencies.**
>
...
**Why:** To have libraries that 'just work' on all platforms.
