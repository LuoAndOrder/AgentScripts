...
It is common for thevisit_*methods to return void (as opposed to in the
...
common way to do this is to providewalk_*functions for each datum. For
example,
...
In other languages (e.g., Java) it is common for data to have anacceptmethod
...
Thefoldpattern is similar to visitor but produces a
