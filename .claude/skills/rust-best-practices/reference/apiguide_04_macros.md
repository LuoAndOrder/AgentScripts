...
input, preface the name with the keywordstructto signal to readers that a
...
default, public ifpubis specified.
...
If your macro accepts a type fragment like$t:tyin the input, it should be
