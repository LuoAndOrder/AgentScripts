...
**Why:** To prevent consistency and correctness issues between crate versions.
...
**Why:** To make otherwise hard-to-evoke edge cases testable.
...
**Why:** To prevent accidentally leaking unintended types.
...
**Why:** To have and maintain the right data and safety variants, at the right time.
...
**Why:** To prevent production builds from accidentally bypassing safety checks.
